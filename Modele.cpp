...
string *generation_regles_Griffeath(const unsigned int nb_voisins)
{
    ...
    //etat_depart | 0 (jaune) |  1 (orange clair) | 2 (orange foncé) |  3 (rouge) | etat_arrivee
    ...
    string tab[500];
    int m = 0;
    for (size_t i = 0; i < 10; i++) // 0 (jaune)
    {
        for (size_t j = 0; j < 10; j++) // 1 (orange clair)
        {
            for (size_t k = 0; k < 10; k++) //  2 (orange foncé)
            {
                for (size_t l = 0; l < 10; l++) // 3 (rouge)
                {
